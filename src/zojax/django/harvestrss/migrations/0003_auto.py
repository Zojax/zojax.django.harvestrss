...
class Migration(SchemaMigration):
    ...
    models = {
        'harvestrss.article': {
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'harvestrss_article_related'", 'blank': 'True', 'to': "orm['sites.Site']"}),
        ...
        'harvestrss.harvestedfeed': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'harvestrss_harvestedfeed_related'", 'blank': 'True', 'to': "orm['sites.Site']"}),
